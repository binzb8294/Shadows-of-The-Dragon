...
death_frames = [
    pygame.image.load("ghoulAlive.png"),
    pygame.image.load("ghoulDeath1.png"),
    pygame.image.load("ghoulDeath2.png"),
    pygame.image.load("ghoulDeath3.png"),
    pygame.image.load("ghoulDeath4.png"),
    pygame.image.load("ghoulDead5.png"),
